...
type Config struct { //nolint:govet // I want it be pretty
	...
	FileStoragePath string        `env:"FILE_STORAGE_PATH" mapstructure:"FILE_STORAGE_PATH" envDefault:"backup.json"`
	Restore         bool          `env:"RESTORE"           mapstructure:"RESTORE"           envDefault:"true"`
